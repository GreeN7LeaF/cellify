...
namespace Cellphone.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "C_ID,C_Password,C_Email,C_Phone,C_is_Admin,C_is_Active,C_Created_at,C_Updated_at")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "C_ID,C_Password,C_Email,C_Phone,C_is_Admin,C_is_Active,C_Created_at,C_Updated_at")] User user)
        {
            if (ModelState.IsValid)
            {
